...
public interface IMediatRMappingService
{
    ...
    Task RebuildMappingsAsync(CancellationToken cancellationToken = default);
    ...
    Task<HandlerMapping?> FindHandlerForRequestSymbolAsync(ITypeSymbol requestType, CancellationToken cancellationToken = default);
